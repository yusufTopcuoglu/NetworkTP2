...
class ThreadingUDPRequestHandler(socketserver.BaseRequestHandler):
    ...
    def handle(self):
        ...
        try:
            # Send incoming to the destination
            global udp_internet_address_to_dest
            # sock.sendto(data, ("10.10.5.2", 5004))
...
udp_internet_address_from_brok = ("127.0.0.1", 5002)
udp_internet_address_to_brok = ("127.0.0.1", 6004)
udp_internet_address_from_dest = ("127.0.0.1", 6002)
udp_internet_address_to_dest = ("127.0.0.1", 5004)


if __name__ == "__main__":
    print("Router 2 server is initiated.")

    # The address that will listen udp client
    # udp_internet_address = ("10.10.4.2", 5002)
